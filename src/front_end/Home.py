...
if st.session_state.get("user_id") is None:
    hero_title(
        ...
        "Explore uploaded data, run forecasts, and track prediction history.",
    )
...
<div class="thesis-feature-card">
  ...
  <ul>
    ...
    <li><strong>Forecast</strong> — upload data and run 24h / 72h / 168h PM₂.₅ forecasts (LSTM / XGBoost)</li>
...
<p>This platform uses <strong>LSTM and XGBoost</strong> models on hourly
multivariate panels from air quality monitoring networks. Open <strong>Data Explorer</strong>
for distribution views, or <strong>Forecast</strong> to generate hourly
predictions from your uploaded file.</p>
""")
